...
function silSrc(char)       { return `${ASSET_BASE}silhouettes/${silFile(char)}.png?v=312`; }
function silColorSrc(char)  { return `${ASSET_BASE}silhouettes/color/${silFile(char)}.png?v=312`; }
function silFocus() {
